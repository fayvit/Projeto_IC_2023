...
public class GameController : MonoBehaviour
{
    ...
    private void OnChangeActiveScene(IGameEvent e)
    {
        ...
        new PlusMapConstruct().ProcessarImagensDosMapas();

        if (InterstialChangeSceneManager.OnChangeScene())
        {
            EventAgregator.Publish(EventKey.requestShowInterstial);
            //InterstialAdManager.RequestShowInterstial();
        }

        EventAgregator.Publish(EventKey.prepareInterstial);
        //InterstialAdManager.PrepareInterstial();
